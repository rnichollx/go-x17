...
import (
	...
	"github.com/rnicholl/go-x17/blake"
	"github.com/rnicholl/go-x17/bmw"
	"github.com/rnicholl/go-x17/cubed"
	"github.com/rnicholl/go-x17/echo"
	"github.com/rnicholl/go-x17/fugue"
	"github.com/rnicholl/go-x17/groest"
	"github.com/rnicholl/go-x17/hamsi"
	"github.com/rnicholl/go-x17/hash"
	"github.com/rnicholl/go-x17/haval"
	"github.com/rnicholl/go-x17/jhash"
	"github.com/rnicholl/go-x17/keccak"
	"github.com/rnicholl/go-x17/luffa"
	"github.com/rnicholl/go-x17/shabal"
	"github.com/rnicholl/go-x17/shavite"
	"github.com/rnicholl/go-x17/simd"
	"github.com/rnicholl/go-x17/skein"
	"github.com/rnicholl/go-x17/whirlpool_x17"
)
